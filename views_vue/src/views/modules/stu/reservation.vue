...
<!--        <el-button v-if="isAuth('sys:user:delete')" type="danger" @click="deleteHandle()" :disabled="dataListSelections.length <= 0">批量删除</el-button>-->
    ...
    <el-table
      ...
      <el-table-column
        ...
        label="操作">
        <template slot-scope="scope">
          <el-button v-if="isAuth('course:student:save') && !scope.row.zf" type="text" size="small" @click="addOrUpdateHandle(scope.row.id, scope.row)">预约</el-button>
          <el-button disabled v-else type="text" size="small" @click="addOrUpdateHandle(scope.row.id, scope.row)">预约</el-button>
        </template>
      </el-table-column>
    </el-table>
    <el-pagination
